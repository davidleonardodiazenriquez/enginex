...
from core.contracts import associate, claim_run, ingest_pdf, process_run, queue_extraction, validate_fields
from core.models import Asset, AssociationEvent, ContractDocument, ExtractedField, ExtractionRun, LeaseRecord, PortfolioMetrics
from core.reporting import record_rows
...
class ContractFlowTests(TestCase):
    ...
    def test_csv_preserves_field_provenance_without_synthetic_source_links(self):
        record=LeaseRecord.objects.create(code='DEMO-CSV',origin='synthetic',data={'tenant_name':'=1+1','annual_rent':100})
...
class AdditivePortfolioTests(TestCase):
    ...
    def test_each_location_opens_its_own_dashboard_and_chat_scope(self):
        ...
        with override_settings(**FOUNDRY_SETTINGS),patch('core.views.foundry.get_answer',return_value='Gate demo') as answer:
