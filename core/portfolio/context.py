...
def asset_context(asset):
    ...
    context["resident_feedback"] = property_feedback(asset)
    ...
    for row in record_rows(records):
        context["document_evidence"].append({
            ...
            "association":"A saved portfolio association, automatic or manual; the PDF is authoritative for its stated premises.",
