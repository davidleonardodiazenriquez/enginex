    ...
    for record in records:
        ...
        for name in selected:
            ...
            fields.append({"name":name,"label":field_label(name),"baseline":baseline,
                           "display_baseline":portfolio_text(baseline) if record.origin=="synthetic" else baseline,
...
def portfolio_summary(asset=None):
    ...
    return {
        ...
        "location_review_documents":documents.filter(association_status="review").count(),
